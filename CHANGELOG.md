...
- **Section 1.1's figure is now one line per detector across the whole budget range (#29),
  ...
  about. Both axes are unchanged in what they measure; both are now logarithmic, because
  measured operating points span decades where the previous figure's hand-placed ticks spanned
  one
